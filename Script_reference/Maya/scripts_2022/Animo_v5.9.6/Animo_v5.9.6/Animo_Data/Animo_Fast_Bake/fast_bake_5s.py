        ...
        if selection:
            ...
            if CBsel:
                if EndRange - StartRange == 0:
                    cmds.bakeResults(sm=True, pok=True, t=(Min, Max), at=CBsel, sb="5")
                else:
                    cmds.bakeResults(sm=True, pok=True, t=(StartRange, EndRange), at=CBsel, sb="5")
            else:
                if EndRange - StartRange == 0:
                    cmds.bakeResults(sm=True, pok=True, t=(Min, Max), sb="5")
                else:
                    cmds.bakeResults(sm=True, pok=True, t=(StartRange, EndRange), sb="5")
