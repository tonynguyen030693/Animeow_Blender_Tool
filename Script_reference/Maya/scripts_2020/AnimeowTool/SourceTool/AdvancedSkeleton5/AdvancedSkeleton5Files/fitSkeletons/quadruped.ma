...
//Name: quadruped.ma
//Last modified: Fri, Mar 11, 2016 01:50:51 PM
//Codeset: 1252
requires maya "2008";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -28.992878010949191 15.178794849236505 15.864676940438914 ;
	setAttr ".r" -type "double3" -15.338352760959145 -65.799999999998349 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 39.832427061553588;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 131.98434623320694 6.9870890141891593 1.0336209804204728 ;
...
createNode joint -n "backRump" -p "Root";
	...
	setAttr ".r" -type "double3" -1.2323890982879133e-013 -1.3498144643793986e-013 1.2722218725854211e-014 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "backToes" -p "backAnkle";
	...
	addAttr -ci true -sn "fatYabs" -ln "fatYabs" -at "double";
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".t" -type "double3" 1.166724960471307 -0.51456930768330178 -6.8049357176939881e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
createNode joint -n "backToesEnd" -p "backToes";
	addAttr -ci true -k true -sn "fat" -ln "fat" -dv 2.4338138454722005 -min 0 -at "double";
	addAttr -ci true -k true -sn "fatY" -ln "fatY" -dv 1 -min 0 -at "double";
	addAttr -ci true -k true -sn "fatZ" -ln "fatZ" -dv 1 -min 0 -at "double";
	addAttr -ci true -sn "fatYabs" -ln "fatYabs" -at "double";
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".t" -type "double3" 0.18660813386414435 -0.49762169030438308 6.4392935428259079e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 -1.8488382930078133e-032 0 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
createNode joint -n "frontToes" -p "frontAnkle";
	...
	addAttr -ci true -sn "fatYabs" -ln "fatYabs" -at "double";
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".t" -type "double3" 1.1218618665917055 -0.56930989580536229 -4.3636930878176723e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
	...
	setAttr ".fatYabs" 0.10000000149011612;
	setAttr ".fatZabs" 0.10000000149011612;
createNode joint -n "frontToesEnd" -p "frontToes";
	addAttr -ci true -k true -sn "fat" -ln "fat" -dv 2.4590705413009739 -min 0 -at "double";
	addAttr -ci true -k true -sn "fatY" -ln "fatY" -dv 1 -min 0 -at "double";
	addAttr -ci true -k true -sn "fatZ" -ln "fatZ" -dv 1 -min 0 -at "double";
	addAttr -ci true -sn "fatYabs" -ln "fatYabs" -at "double";
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".t" -type "double3" 0.13477254112410411 -0.41468474192031923 4.6629367034256575e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 2.3838895724495637e-030 -1.4124500153760508e-030 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 0.96 -max 23.04 -ast 0.96 -aet 46.08 ";
	setAttr ".st" 6;
...
connectAttr "backToes.s" "backToesEnd.is";
...
connectAttr "frontToes.s" "frontToesEnd.is";
