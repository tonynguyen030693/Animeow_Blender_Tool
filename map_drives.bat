@echo off
echo ======================================================
echo   TU DONG KET NOI O DIA MANG V VA Z (ANIMEOW PIPELINE)
echo ======================================================
echo.
...
:: 3. Ket noi o dia V
echo [*] Dang ket noi o dia V: -^> \\192.168.1.239\Animeow\Project\EnjoHub\Project_Enjo
net use V: "\\192.168.1.239\Animeow\Project\EnjoHub\Project_Enjo" /persistent:yes
if %errorlevel% equ 0 (
    echo [OK] Da ket noi o dia V thanh cong.
) else (
    echo [LOI] Khong the ket noi o dia V.
)
