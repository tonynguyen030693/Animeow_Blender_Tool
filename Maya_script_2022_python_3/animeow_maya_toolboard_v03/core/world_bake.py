...
class WorldBakeManager(object):
    ...
    def get_associated_locator(self, obj):
        """Trả về locator thế giới liên kết với obj nếu đã được bake trước đó, ngược lại trả về None"""
        if not cmds.objExists(obj):
            return None
            
        # 1. Kiểm tra qua kết nối message
        ...
        # 2. Kiểm tra qua tên locator mặc định
