...
def create_shelf():
    ...
    tools = [
        ...
        {
            "label": "Tr2Cr",
            "annotation": "Chuyển Motion Trail thành Curve (Motion Trail to Curve)",
        ...
        },
        {
            ...
            "image": "commandButton.png",
            "command": common_path_init + "import {pkg}.core.shelf as shelf; shelf.launch_animo()".format(pkg=package_name)
        }
    ]
