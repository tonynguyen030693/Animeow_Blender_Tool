        ...
        if selection:
            ...
            if CBsel:
                if EndRange - StartRange == 0:
                    cmds.bakeResults(sm=True, pok=True, t=(Min, Max), at=CBsel, sb="2")
                else:
                    cmds.bakeResults(sm=True, pok=True, t=(StartRange, EndRange), at=CBsel, sb="2")
            else:
                if EndRange - StartRange == 0:
                    cmds.bakeResults(sm=True, pok=True, t=(Min, Max), sb="2")
                else:
                    cmds.bakeResults(sm=True, pok=True, t=(StartRange, EndRange), sb="2")
